...
"""
# used when uploading to the server, change to your directory:
os.environ["pathvar"] = "C:/Users/eliza/Desktop/CIRCUIT/PyCharm/BYTES/circuit2020_BYTES_HouseKristoff_skrrt/stockfish_20011801_x64.exe"
STOCKFISH_ENV_VAR = "pathvar" 
"""

class SkrrtBot(Player):
    def __init__(self):
        self.board = None
        self.color = None
    ...
    def handle_opponent_move_result(self, captured_my_piece: bool, capture_square: Optional[Square]):
        ...
        """ if this square is replaced with an opponent's piece, handle_sense_result will add that
            piece to our board """
    ...
    def choose_sense(self, sense_actions: List[Square], move_actions: List[chess.Move], seconds_left: float) -> \
        ...
        """perhaps sense in rows 3 and 4 of the opponent during the beginning of the game...?"""
    ...
    def choose_move(self, move_actions: List[chess.Move], seconds_left: float) -> Optional[chess.Move]:
        ...
        """ note: since the obj of reconchess is to capture the king, we must ensure stockfish is also bringing
            us closer to this goal, i.e. besides being in check """
        try:
    ...
    def handle_move_result(self, requested_move: Optional[chess.Move], taken_move: Optional[chess.Move],
        ...
        """
        # if we captured opponent's piece, remove piece from our board (Producing error)
        self.opponent_piece_captured_square = capture_square
